...
Both broad and explicit-wording cohorts appear in the sensitivity table.
...
The generated sensitivity table crosses two alias rules, four market populations,
...
seed of 20260907 over an ID-sorted pool. Python's version is recorded. This is a
